...
public class Client {
	...
	public Client status(@Nullable String status) {
		this.status = status;
		return this;
	}
	...
	public Client title(@Nullable String title) {
		this.title = title;
		return this;
	}
	...
	public Client forename(@Nullable String forename) {
	...
	public Client surname(@Nullable String surname) {
	...
	public Client gender(@Nullable String gender) {
		this.gender = gender;
		return this;
	}
	...
	public Client dateOfBirth(@Nullable LocalDate dateOfBirth) {
	...
	public Client occupation(@Nullable String occupation) {
	...
	public Client preferredRiskCode(@Nullable String preferredRiskCode) {
	...
	public Client addressTypeCode(@Nullable String addressTypeCode) {
	...
	public Client line1(@Nullable String line1) {
		this.line1 = line1;
		return this;
	}
	...
	public Client line2(@Nullable String line2) {
		this.line2 = line2;
		return this;
	}
	...
	public Client line3(@Nullable String line3) {
		this.line3 = line3;
		return this;
	}
	...
	public Client line4(@Nullable String line4) {
		this.line4 = line4;
		return this;
	}
	...
	public Client suburb(@Nullable String suburb) {
		this.suburb = suburb;
		return this;
	}
	...
	public Client city(@Nullable String city) {
		this.city = city;
		return this;
	}
	...
	public Client country(@Nullable String country) {
	...
	public Client postCode(@Nullable String postCode) {
	...
	public Client primary(@Nullable Boolean primary) {
	...
	public Client email(@Nullable String email) {
		this.email = email;
		return this;
	}
	...
	public Client mobilePhone(@Nullable String mobilePhone) {
	...
	public Client homePhone(@Nullable String homePhone) {
	...
	public Client businessPhone(@Nullable String businessPhone) {
	...
	public Client comments(@Nullable String comments) {
	...
	public Client createdDate(@Nullable OffsetDateTime createdDate) {
	...
	public Client modifiedDate(@Nullable OffsetDateTime modifiedDate) {
