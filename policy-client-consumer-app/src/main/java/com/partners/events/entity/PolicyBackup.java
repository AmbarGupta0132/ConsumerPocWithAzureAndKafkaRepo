 ...
 */
@Entity
@Table(name = "policy_backup")
public class PolicyBackup {
     ...
     */
    public PolicyBackup(PolicyId id) {
        this.id = id;
    }

    public PolicyBackup id(PolicyId id) {
        this.id = id;
        return this;
    }
    ...
    public PolicyBackup status(@Nullable String status) {
        this.status = status;
        return this;
    }
    ...
    public PolicyBackup productName(@Nullable String productName) {
    ...
    public PolicyBackup riskCommence(@Nullable LocalDate riskCommence) {
    ...
    public PolicyBackup relationshipType(@Nullable String relationshipType) {
    ...
    public PolicyBackup adviserNumber(@Nullable String adviserNumber) {
    ...
    public PolicyBackup paymentFrequency(@Nullable String paymentFrequency) {
    ...
    public PolicyBackup annualPremium(@Nullable Double annualPremium) {
    ...
    public PolicyBackup instalmentPrem(@Nullable Double instalmentPrem) {
    ...
    public PolicyBackup expenseAnnualPremium(@Nullable Double expenseAnnualPremium) {
    ...
    public PolicyBackup nextAnniversaryDate(@Nullable OffsetDateTime nextAnniversaryDate) {
    ...
    public PolicyBackup outstandingBalance(@Nullable Double outstandingBalance) {
    ...
    public PolicyBackup nextPaymentDueDate(@Nullable OffsetDateTime nextPaymentDueDate) {
    ...
    public PolicyBackup comments(@Nullable String comments) {
    ...
    public PolicyBackup createdDate(@Nullable OffsetDateTime createdDate) {
    ...
    public PolicyBackup modifiedDate(@Nullable OffsetDateTime modifiedDate) {
    ...
    public boolean equals(Object o) {
        ...
        PolicyBackup policy = (PolicyBackup) o;
